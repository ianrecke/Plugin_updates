...
class LayoutCircular(BnLayout):
    ...
    def __init__(self, graph, graph_initial_width=None,
        ...
        """
        Circular Layout class constructor.
        @param graph:
        @param graph_initial_width:
        @param graph_initial_height:
        """
        super(LayoutCircular, self).__init__(graph, graph_initial_width,
    ...
    def run(self):
        ...
        self.layout = {}
        layout = graph_igraph.layout('circular')
